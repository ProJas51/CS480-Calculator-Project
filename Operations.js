...
function onButtonPress(button) { 
    ...
    // updates screen input for trig functions 
      ...
      //  value = button.value; 
        //calc_data.expression.push(symbol);
        //calc_data.equiv_form.push(value);
    ...
    // updates solution to equation 
        ...
        let POWER_SEARCH_RESULT = search(calc_data.equiv_form, "power"); 

        value_str = calc_data.equiv_form.join('');  

        let result = eval(value_str); 
    ...
    function onCalculatePress(expression) { 
        ...
        let computation = unaryOp(expression); 
        console.log("---------------------------"); 
